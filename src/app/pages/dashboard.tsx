      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            {account?.plan === "none" && (
              <Link to="/billing" className="mt-2 block text-sm text-primary underline-offset-4 hover:underline">
        ...
        <CardContent>
          {campaigns === null ? (
            ...
            <p className="py-6 text-center text-sm text-muted-foreground">
              No campaigns yet.{" "}
              <Link to="/campaigns/new" className="text-primary underline-offset-4 hover:underline">
