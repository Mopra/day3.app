  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link to="/admin/reviews" className="text-sm text-primary underline-offset-4 hover:underline">
          Campaign reviews →
        </Link>
      </div>
            ...
            <Table>
              ...
              <TableBody>
                {accounts.map((a) => (
                  <TableRow key={a.id}>
                    <TableCell>
                      <Link to={`/admin/accounts/${a.id}`} className="font-medium hover:underline">
                        {a.name}
                      </Link>
                    </TableCell>
