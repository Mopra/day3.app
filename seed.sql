-- Local development seed (npm run db:seed). Idempotent via INSERT OR IGNORE.
...
INSERT OR IGNORE INTO accounts (
  ...
  10000, 0,
  1, 'normal', 'Seed Co, 1 Example Street, Copenhagen, DK',
  '2026-06-13T00:00:00.000Z', '2026-06-13T00:00:00.000Z'
);

INSERT OR IGNORE INTO sending_domains (
  ...
  'cloudflare', 'pending', 'pending', 1,
  '2026-06-13T00:00:00.000Z', '2026-06-13T00:00:00.000Z'
);

INSERT OR IGNORE INTO audiences (id, account_id, name, created_at, updated_at)
VALUES (
