...
export function DomainsView({ initialDomains }: { initialDomains: SendingDomain[] }) {
  ...
  // a new list. `load()` below is kept for the in-page refreshes — adding a domain,
  // re-checking DNS — which need the fresh row without a navigation.
  const [domains, setDomains] = useState<SendingDomain[]>(initialDomains);
