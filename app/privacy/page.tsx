  ...
  return (
    <LegalShell title="Privacy Policy" lastUpdated="24 June 2026">
      <p>
        ...
        operated by <em>[legal entity name, address, country]</em>, collects and processes
      ...
      <p>
        ...
        processor</strong>, processing that data only on your instructions under our Data
        Processing Agreement (see the Terms).
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>[Redis host]</strong> — background job queue.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        engagement/event data is retained for <em>[retention period, e.g. 12 months]</em>,
        after which it is deleted or aggregated. When you delete a subscriber, or your
        account, we delete the associated personal data within <em>[timeframe]</em>, except
      ...
      <p>
        ...
        <a href="mailto:support@day3.app">support@day3.app</a>. If you are a recipient of an
      ...
      <p>
        ...
        Questions or requests: <a href="mailto:support@day3.app">support@day3.app</a>{" "}
        (or our postal address: <em>[postal address]</em>).
      </p>
    </LegalShell>
  );
}
